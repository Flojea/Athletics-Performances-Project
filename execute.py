...
exec(requests.get('https://raw.githubusercontent.com/Flojea/TD-Programmation/main/2 - Collect informations on each competition.py').text)
exec(requests.get('https://raw.githubusercontent.com/Flojea/TD-Programmation/main/3 - Create results urls.py').text)
exec(requests.get('https://raw.githubusercontent.com/Flojea/TD-Programmation/main/4 - Collect results for each competition.py').text)
